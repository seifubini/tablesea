...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Restaurant Users </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>{{ date_format(date_create($user->created_at), 'jS M Y')}}
                    </td>
                    <td>
                        @if($user->id != Auth::user()->id)
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="{{ route('administrator.store')}}" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        <label for="inputName2" class="col-sm-2 col-form-label">Number of Restaurants</label>
                        <div class="col-sm-10">
                            <input type="number" class="form-control" placeholder="Number of Restaurants" name="no_of_restaurants" required>
                        </div>
                    </div>
                    <div class="form-group row">
