...
@section('content')
                        ...
                        <div class="row">
                            <div class="col-8 form-group">
                                <div class="input-group date" data-target-input="nearest">
                                    <input type="date" name="date_of_reservation" value="{{$date}}" class="form-control datetimepicker-input" id="sort_date" required>
                                </div>
                            </div>
    ...
    <div class="content">
        ...
        <span class="color_code" title="Confirmed" style="height: 25px; width: 25px; border-radius: 50%; background-color: #D7F7A1; display: inline-block;">
                                ...
                                <div class="card card-default" id="reservation_status">
                                    ...
                                    @if($reservation->reservation_status == 'confirmed')
                                        <div class="row" style="background-color: #D7F7A1; color: #74B10C; border-radius: 10px;">
                                            <div role="button" id="{{$reservation->reservation_code}}"
                                                 title="{{ route('booked_tables', $reservation->id) }}" class="col-md-12 open_modal"
                                                 data-href="{{ $reservation->id }}" data-toggle="modal" href="#modal-lg{{ $reservation->id }}"
                                                 data-action="{{$reservation->reservation_status}}" style="color:#74B10C; font-size: 20px;">
                                    ...
                                    @elseif($reservation->reservation_status == 'Completed')
                                        <div class="row" style="background-color: #0065A3; color: #fff; border-radius: 10px;">
                                            <div role="button" id="{{$reservation->reservation_code}}" class="col-md-12 open_modal"
                                                 data-href="{{ $reservation->id }}" title="{{ route('booked_tables', $reservation->id) }}"
                                                 data-toggle="modal" href="#modal-lg{{ $reservation->id }}" data-action="{{$reservation->reservation_status}}"
                                    ...
                                    @elseif($reservation->reservation_status == 'cancelled')
                                        <div class="row" style="background-color: #E6292D; color: #fff; border-radius: 10px;">
                                            <div role="button" id="{{$reservation->reservation_code}}" title="{{ route('booked_tables', $reservation->id) }}"
                                                 class="col-md-12 open_modal" data-href="{{ $reservation->id }}" data-toggle="modal"
                                                 href="#modal-lg{{ $reservation->id }}" data-action="{{$reservation->reservation_status}}"
                                                 style="color:#fff; font-size: 20px;">
                                    ...
                                    @else
                                        <div class="row" style="background-color: #E7F6FF; color: #0065A3; border-radius: 10px;">
                                            <div role="button" title="{{ route('booked_tables', $reservation->id) }}" class="col-md-12 open_modal"
                                                 data-href="{{ $reservation->id }}" data-toggle="modal" href="#modal-lg{{ $reservation->id }}"
                                                 data-action="{{$reservation->reservation_status}}" style="color:#0065A3; font-size: 20px;">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-4">
                                                                        <input type="number" id="people{{$reservation->id}}" name="number_of_people" value="{{ $reservation->number_of_people }}" class="form-control">
                                                                    </div>
                                                                    <div class="col-8">
                ...
                <!-- Tables list with their original positions -->
                <div class="col-md-9">
                        ...
                        <div class="card-body" style="margin:0; padding:0; list-style-type:none; height: 500px;
                            ...
                            <section class="tables_position-list" style="margin: 0; padding: 0; list-style: none;">
                                @foreach($tables as $table)
                                    <li style="padding: 0; list-style: none; float:left; margin:10px 7px;
    background:none; width:auto; height:auto;">
                                        ...
                                        <p class="text-center" style="font-size: 12px;" id="badge{{$table->id}}">{{$table->table_name}}</p>
                                    </li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label>Reservation Date</label>
                                    <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                        <input type="date" min="{{ $today }}" id="reservation_date" name="date_of_reservation" class="form-control datepicker-input" data-target="#reservationdate"/>
