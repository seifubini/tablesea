...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit Restaurant Information </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ url('/dashboard')}}">Home</a></li>
              <li class="breadcrumb-item"><a href="{{ url('/restaurants')}}">Restaurants</a></li>
              ...
              <form method="POST" action="{{ route('restaurants.update', $restaurant->id) }}" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="Restaurant_name" value="{{ $restaurant->Restaurant_name}}" id="exampleInputName1"
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="Restaurant_phone" value="{{ $restaurant->Restaurant_phone}}" required >
                  </div>
                </div>
                <div class="form-group">
                    <label for="exampleInputPassword1">Restaurant Address</label>
                    <input type="text" class="form-control" name="Restaurant_address" value="{{$restaurant->Restaurant_address}}"
                    ...
                    <div class="row form-group">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="Restaurant_price_range" style="width: 100%;">
                                    <option value="{{$restaurant->Restaurant_price_range}}" selected>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="restaurant_currency" style="width: 100%;" required>
                                    <option value="{{$restaurant->restaurant_currency}}" selected>
                                        {{$restaurant->restaurant_currency}}
                                    </option>
                                    <option value="$">$</option>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="Restaurant_Country" style="width: 100%;" required>
                                    <option value="{{$restaurant->Restaurant_Country}}" selected>{{$restaurant->Restaurant_Country}}</option>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputName1" value="{{$restaurant->Restaurant_City}}"
                ...
                <div class="form-group">
                        ...
                        <select class="form-control select2" name="Restaurant_type" style="width: 100%;" required>
                            <option value="{{$restaurant->Restaurant_type}}">{{$restaurant->Restaurant_type}}</option>
                ...
                <!--<div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputName1" value="{{$restaurant->Restaurant_type}}"
                           name="Restaurant_type" placeholder="Restaurant Type" required>
                </div>
                   <div class="form-group">
                    <label for="exampleInputPassword1">Restaurant Working Hours</label>
                    <input type="text" class="form-control" id="exampleInputName1" name="Restaurant_hours" value="{{$restaurant->Restaurant_hours}}"
                    placeholder="Restaurant Address" required>
                  </div>-->
                  <div class="form-group">
                  ...
                  <!-- --><div class="form-group">
                    ...
                    <div class="row form-group">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" placeholder="Reservation Update Type" name="Reservation_update_type" style="width: 100%;" required>
                                    <option value="{{$restaurant->Reservation_update_type}}">{{$restaurant->Reservation_update_type}}</option>
                    ...
                    <div class="form-group" style="width: 100%;">
                        ...
                        <div class="input-group" id="working_days">
                            @if($restaurant->monday_open == 'yes')
                            <div class="col-sm-1">
                                <div class="form-group">
                                    <label>Monday</label>
                                    <input class="form-control form-check-input" value="yes" checked name="monday" type="checkbox" id="monday">
                                </div>
                            </div>
                            @else
                                <div class="col-sm-1">
                            ...
                            @endif
                            @if($restaurant->tuesday_open == 'yes')
                                <div class="col-sm-1" style="width: 300px; margin: 0 auto; text-align: center;">
                                    <div class="form-group">
                                        <label>Tuesday</label>
                                        <input class="form-control form-check-input" value="yes" checked name="tuesday" type="checkbox" id="tuesday">
                                    </div>
                                </div>
                            @else
                                <div class="col-sm-1" style="width: 300px; margin: 0 auto; text-align: center;">
                            ...
                            @endif
                            @if($restaurant->wednesday_open == 'yes')
                                <div class="col-sm-1" style="width: 300px; margin: 0 auto; text-align: center;">
                                    <div class="form-group">
                                        <label for="exampleInputFile">Wednesday</label>
                                        <input class="form-control form-check-input" value="yes" checked name="wednesday" type="checkbox" id="wednesday">
                                    </div>
                                </div>
                            @else
                                <div class="col-sm-1" style="width: 300px; margin: 0 auto; text-align: center;">
                            ...
                            @endif
                            @if($restaurant->thursday_open == 'yes')
                                <div class="col-sm-1" style="width: 300px; margin: 0 auto; text-align: center;">
                                    <div class="form-group">
                                        <label for="exampleInputFile">Thursday</label>
                                        <input class="form-control form-check-input" value="yes" checked name="thursday" type="checkbox" id="thursday">
                                    </div>
                                </div>
                            @else
                                <div class="col-sm-1" style="width: 300px; margin: 0 auto; text-align: center;">
                            ...
                            @endif
                            @if($restaurant->friday_open == 'yes')
                                <div class="col-sm-1" style="width: 300px; margin: 0 auto; text-align: center;">
                                    <div class="form-group">
                                        <label for="exampleInputFile">Friday</label>
                                        <input class="form-control form-check-input" value="yes" checked name="friday" type="checkbox" id="friday">
                                    </div>
                                </div>
                            @else
                                <div class="col-sm-1" style="width: 300px; margin: 0 auto; text-align: center;">
                            ...
                            @endif
                            @if($restaurant->saturday_open == 'yes')
                                <div class="col-sm-1" style="width: 300px; margin: 0 auto; text-align: center;">
                                    <div class="form-group">
                                        <label for="exampleInputFile">Saturday</label>
                                        <input class="form-control form-check-input" value="yes" checked name="saturday" type="checkbox" id="saturday">
                                    </div>
                                </div>
                            @else
                                <div class="col-sm-1" style="width: 300px; margin: 0 auto; text-align: center;">
                            ...
                            @endif
                            @if($restaurant->sunday_open == 'yes')
                                <div class="col-sm-1" style="width: 300px; margin: 0 auto; text-align: center;">
                                    <div class="form-group">
                                        <label for="exampleInputFile">Sunday</label>
                                        <input class="form-control form-check-input" value="yes" checked name="sunday" type="checkbox" id="sunday">
                                    </div>
                                </div>
                            @else
                                <div class="col-sm-1" style="width: 300px; margin: 0 auto; text-align: center;">
                                ...
                                <div class="bootstrap-timepicker">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" id="timepicker" data-target-input="nearest">
                                            <input type="time" name="restaurant_opening_hour" value="{{$restaurant->restaurant_opening_hour}}"
                            ...
                            <div class="col-6">
                                ...
                                <div class="bootstrap-timepicker">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" id="timepicker" data-target-input="nearest">
                                            <input type="time" name="restaurant_closing_hour" value="{{$restaurant->restaurant_closing_hour}}"
                                                   class="form-control datetimepicker-input" data-target="#timepicker"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row" style="margin: 0 auto; float: left;">
                            @if(!is_null($breakfast_hour))
                            <div class="col-sm-3" style="margin: 0 auto; float: left;">
                                <div class="form-group" style="margin: 0 auto; text-align: left;">
                                    <label>Breakfast</label>
                                    <input class="form-control form-check-input" value="yes" type="checkbox" checked id="breakfast" onchange="myFunction()">
                                </div>
                            </div>
                            @else
                            <div class="col-sm-3" style="margin: 0 auto; float: left;">
                            ...
                            @if(!is_null($lunch_hour))
                            <div class="col-sm-3" style=" margin: 0 auto; float: left;">
                                <div class="form-group" style="margin: 0 auto; float: left;">
                                    <label>Lunch</label>
                                    <input class="form-control form-check-input" value="yes" checked type="checkbox" id="lunch" onchange="myFunction()">
                                </div>
                            </div>
                            @else
                            <div class="col-sm-3" style=" margin: 0 auto; float: left;">
                            ...
                            @endif
                            <div class="col-sm-1"></div>
                            @if(!is_null($dinner_hour))
                            <div class="col-sm-3" style="margin: 0 auto; float: left;">
                                <div class="form-group" style="margin: 0 auto; float: left;">
                                    <label>Dinner</label>
                                    <input class="form-control form-check-input" value="yes" checked type="checkbox" id="dinner" onchange="myFunction()">
                                </div>
                            </div>
                            @else
                            <div class="col-sm-3" style="margin: 0 auto; float: left;">
                    ...
                    @if(!is_null($breakfast_hour))
                        <div class="form-group" id="breakfast_hours">
                        ...
                        <div class="row input-group">
                            <div class="col-6">
                                ...
                                <div class="bootstrap-timepicker">
                                    <div class="form-group">
                                        <label>Start</label>
                                        <div class="input-group date" id="timepicker" data-target-input="nearest">
                                            <input type="time" name="breakfast_start_hour" value="{{$breakfast_hour->start_hour}}"
                                                   class="form-control datetimepicker-input" data-target="#timepicker"/>
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="bootstrap-timepicker">
                                    <div class="form-group">
                                        <label>End</label>
                                        <div class="input-group date" id="timepicker" data-target-input="nearest">
                                            <input type="time" name="breakfast_end_hour" value="{{$breakfast_hour->end_hour}}"
                                                   class="form-control datetimepicker-input" data-target="#timepicker"/>
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                            ...
                            <input type="hidden" name="Breakfast_Hour_id" value="{{$breakfast_hour->id}}"
                    ...
                    @else
                        <div class="form-group" style="display: none;" id="breakfast_hours">
                            ...
                            <div class="row input-group">
                                ...
                                <input type="hidden" name="Breakfast_Hours" style="display: none;"
                                       class="form-control" value="Breakfast Hours">
                            </div>
                        </div>
                    @endif

                    @if(!is_null($lunch_hour))
                        <div class="form-group" id="lunch_hours">
                        ...
                        <div class="row input-group">
                            <div class="col-6">
                                ...
                                <div class="bootstrap-timepicker">
                                    <div class="form-group">
                                        <label>Start</label>
                                        <div class="input-group date" id="timepicker" data-target-input="nearest">
                                            <input type="time" name="lunch_start_hour" value="{{$lunch_hour->start_hour}}"
                                                   class="form-control datetimepicker-input" data-target="#timepicker"/>
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="bootstrap-timepicker">
                                    <div class="form-group">
                                        <label>End</label>
                                        <div class="input-group date" id="timepicker" data-target-input="nearest">
                                            <input type="time" name="lunch_end_hour" value="{{$lunch_hour->end_hour}}"
                                                   class="form-control datetimepicker-input" data-target="#timepicker"/>
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                            ...
                            <input type="hidden" name="Lunch_Hour_id" style="display: none;"
                                   class="form-control" value="{{$lunch_hour->id}}">
                        </div>
                    </div>
                    @else
                        <div class="form-group" style="display: none;" id="lunch_hours">
                            ...
                            <div class="row input-group">
                                ...
                                <input type="hidden" name="Lunch_Hours" style="display: none;"
                                       class="form-control" value="Lunch Hours">
                            </div>
                        </div>
                    @endif

                    @if(!is_null($dinner_hour))
                        <div class="form-group" id="dinner_hours">
                        ...
                        <div class="row input-group">
                            <div class="col-6">
                                ...
                                <div class="bootstrap-timepicker">
                                    <div class="form-group">
                                        <label>Start</label>
                                        <div class="input-group date" id="timepicker" data-target-input="nearest">
                                            <input type="time" name="dinner_start_hour" value="{{$dinner_hour->start_hour}}"
                                                   class="form-control datetimepicker-input" data-target="#timepicker"/>
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="bootstrap-timepicker">
                                    <div class="form-group">
                                        <label>End</label>
                                        <div class="input-group date" id="timepicker" data-target-input="nearest">
                                            <input type="time" name="dinner_end_hour" value="{{$dinner_hour->end_hour}}"
                                                   class="form-control datetimepicker-input" data-target="#timepicker"/>
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                            ...
                            <input type="hidden" name="Dinner_Hour_id" style="display: none;"
                                   class="form-control" value="{{$dinner_hour->id}}">
                        </div>
                    </div>
                    @else
                        <div class="form-group" style="display: none;" id="dinner_hours">
                            ...
                            <div class="row input-group">
                                ...
                                <input type="hidden" name="Dinner_Hours" style="display: none;"
                                       class="form-control" value="Dinner Hours">
                            </div>
                        </div>
                    @endif
                    ...
                    <div class="row form-group">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="Restaurant_duration" style="width: 100%;">
                                    <option value="{{$restaurant->Restaurant_duration}}" selected="selected">{{$restaurant->Restaurant_duration}}</option>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="Restaurant_max_capacity" value="{{$restaurant->Restaurant_max_capacity}}"
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="Restaurant_color" value="{{$restaurant->Restaurant_color}}" class="form-control my-colorpicker1">
                  </div>
                  <!-- /.form group -->
                  <div class="form-group">
                      <!-- textarea -->
                      <div class="form-group">
                        ...
                        <textarea class="form-control" name="Restaurant_description" rows="3"
                                  placeholder="Restaurant Description ..." maxlength = "500">{{$restaurant->Restaurant_description}}</textarea>
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputName1" required name="Restaurant_coordinates" value="{{$restaurant->Restaurant_coordinates}}">
                  </div>
                </div>
                <!-- /.card-body -->
...
<div class="col-md-3">
  <div class="col-sm-6">
            <h3 class="m-0">Restaurant Image </h3>
            <hr>
          </div><!-- /.col -->
  <div class="position-relative" style="min-height: 180px;">
  <img src="{{ asset('images/restaurant') }}/{{ $restaurant->Restaurant_photo}}" alt="Photo 3" class="img-fluid">
  ...
  <br>
  <div class="col-sm-6">
            <h3 class="m-0">Restaurant Logo </h3>
            <hr>
          </div><!-- /.col -->
  <div class="position-relative" style="min-height: 180px;">
  <img src="{{ asset('images/restaurant/logo') }}/{{ $restaurant->Restaurant_logo}}" alt="Photo 3" class="img-fluid">
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-danger">
            <div class="modal-header">
              <h4 class="modal-title">Are you sure you want to delete <br> <strong>"{{ $restaurant->Restaurant_name }}"</strong> ?</h4>
