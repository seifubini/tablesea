...
<br><br>
<a href="{{ route('create_reservation', $restaurant_id)}}">
<button style="color: #fff; background-color: #0065A3; width: 200px; height: 50px; border-radius: 5px;"> Modify Booking </button>
</a>
<br><br>
