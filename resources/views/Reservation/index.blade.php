    ...
    <nav class="navbar fixed-top navbar-expand-lg  p-md-3">
        <div class="container">
            ...
            aria-expanded="false" aria-label="Toggle navigation" class="navbar-toggler navbar-toggler-right">
                <font color="#fff" size="5px"><i class="fa fa-bars"></i></font></button>
...
<!--card content starts-->
<div class="container">
    <p>Showing results for {{$country}}</p>
    <hr>
    <div class="row">
        <div class="col-9 col-sm-10 col-md-10 col-lg-10 col-xl-11">
            <h4><b>Featured Restaurants in Your Area</b></h4>
        </div>

        <div class="col-3 col-sm-2 col-md-2 col-lg-2 col-xl-1">
            <span style="color: #247f9e; ">
                <a href="{{ route('all_restaurants') }}" style="text-decoration:none;"> View all </a>
            </span>
        </div>
    </div>
    ...
    <div class="row d-flex flex-row flex-nowrap overflow-auto no-gutters"  id="slider">


        @foreach($featured_restaurants as $restaurant)
        <div class="col-sm-12 col-12 col-md-6 col-lg-3 col-xl-3  mr-3">

            <div class="card card_blue" style="border-radius:10px;">
                ...
                <div class="row">
                    <div class="col-sm-6 col-4 col-md-4 col-lg-6 col-xl-5" style="margin-left: 10%;">
                        <div class="card-img-overlay  d-flex flex-column justify-content-center card_image_overlay">
                            <div class="card-title bg-success verify_open ">
                                <span class="verify_fa_style"><small><b><i class="fa fa-check"> </i> FEATURED</b></small></span></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <p class="card-text text-light small" style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                        <i class="fa fa-home" aria-hidden="true"></i>&nbsp;&nbsp;{{ $restaurant->Restaurant_address}}
                    </p>
                    <p class="card-text text-light less_spacing_input small" style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                        <i class="fas fa-flag" aria-hidden="true"></i>&nbsp;&nbsp;{{ $restaurant->Restaurant_Country}}, {{ $restaurant->Restaurant_City}}
                    </p>
                    <p class="card-text text-light less_spacing_input small" style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                        <i class="fa fa-money-bill" aria-hidden="true"></i>&nbsp;&nbsp;{{$restaurant->Restaurant_type}} . {{$restaurant->Restaurant_price_range}}
                    </p>
                    <a href="{{ route('reserve_restaurant', $restaurant->id) }}" class="text-black">
                        <button type="button" class="btn btn-light btn-sm" >BOOK TABLE</button>
                    </a>
                </div>
            </div>
...
<!-- Top Cuisines card content starts-->

<div class="container">
    <div class="row">
        <div class="col-9 col-sm-10 col-md-10 col-lg-10 col-xl-11">
            <h4><b>Top Cuisines Near Me</b></h4>
        </div>
        <div class="col-3 col-lg-1 col-xl-1 col-sm-2 col-md-1">
            <div class="btn-group">
        ...
        <div class="container">
            <div class="basic-carousel owl-carousel owl-theme mt-3 add_margin_sm">
                ...
                <!-- Item 2 -->
                <div class="item">
                    <div class="card border-light card_blue">
                        <a href="{{ route('reserve_restaurant', $image->id) }}" style="text-decoration: none;">
                        <img src="{{ asset('images/restaurant')}}/{{$image->Restaurant_photo}}" class="card-img-top cit rounded-top" alt="profile-image">
                        <div class="card-text text-light m-2" style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                            {{$image->Restaurant_type}}</div>
                        </a>
                    </div>
                </div>
                @endforeach
...
<!--popular Restaurant card content starts-->
<div class="container">
    <div class="row">
        <div class="col-9 col-sm-10 col-md-10 col-lg-10 col-xl-11">
            <h4><b>Popular restaurants in Your Country</b></h4>
        </div>

        <div class="col-3 col-sm-2 col-md-2 col-lg-2 col-xl-1">
            <span style="color: #247f9e; "> <a href="{{ route('all_restaurants') }}" style="text-decoration:none;">  View all </a> </span>
        </div>
    </div>
            ...
            <div class="card card_blue" style="border-radius:10px;">
                ...
                <div class="row">
                    <div class="col-sm-6 col-4 col-md-4 col-lg-6 col-xl-5" style="margin-left: 10%;">
                        <div class="card-img-overlay  d-flex flex-column justify-content-center card_image_overlay">
                            <div class="card-title bg-success verify_open ">
                                <span class="verify_fa_style"><small><b><i class="fa fa-check"> </i> VERIFIED</b></small></span></div>
                        </div>
                    </div>
                </div>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-12 col-md-12 col-lg-6 col-xl-6">
            ...
            <div class="card">
                <img class="card-img2" src="{{ asset('Frontend/Images/bg7.png') }}" alt="Table Sea Picture">
                <div style="text-align: center;">
                    <div class="card-img-overlay mt-5">
                        <h3 class="card-text text-light "><b>Own A Restaurant?</b></h3>
                        <a href="https://restaurants.tablesea.com/" style="text-decoration: none;" target="_blank">
                            <button type="button" class="btn btn_style btn-lg mt-3"><b>Join Us</b></button>
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-sm-12 col-12 col-md-12 col-lg-6 col-xl-6">
            ...
            <div class="card mt-1" >
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title mb-1 text-center "><b>TableSea</b></h5>
                    <p class="card-text" >

                        We're the next-generation restaurant management system that will help you manage your restaurant, from a single place.<br>
                        <br>

On Tablesea, you'll never have to worry about managing your bookings in a disorganized way. Our interface provides a simple and intuitive booking experience for both you and your customers.
