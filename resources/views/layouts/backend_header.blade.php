        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" data-widget="pushmenu" href="#" role="button" style="background-color: #0065A3; color: #fff;">
                    <i class="fas fa-bars" style="background-color: #0065A3; color: #fff;"></i></a>
            </li>
            <li class="nav-item">
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    @if(Auth::user()->user_type == "Restaurant" || Auth::user()->user_type == "Administrator")
                        @if(request()->is('my_gallery'))
                            <li class="nav-item">
                                <a href="{{ url('/my_gallery')}}" class="nav-link active" style="background-color: #0065A3; color: #fff;">
                                    <i class="nav-icon fas fa-image" style="color: #fff;"></i>
                                    <p style="color: #fff;">
                                        Restaurant Gallery
                                    </p>
                                </a>
                        ...
                        @else
                            <li class="nav-item">
                                <a href="{{ url('/my_gallery')}}" class="nav-link">
                                    <i class="nav-icon fas fa-image" style="color: #fff;"></i>
                                    <p style="color: #fff;">
                                        Restaurant Gallery
                                    </p>
                        ...
                        @endif
                        @if(request()->is('show_memberships'))
                        <li class="nav-item">
                            <a href="{{ route('show_memberships')}}" class="nav-link active" style="background-color: #0065A3; color: #fff;">
                                <i class="nav-icon fas fa-id-badge" style="color: #fff;"></i>
                                <p style="color: #fff;">
                        ...
                        @else
                        <li class="nav-item">
                            <a href="{{ route('show_memberships')}}" class="nav-link">
                                <i class="nav-icon fas fa-id-badge" style="color: #fff;"></i>
                                <p style="color: #fff;">
                                    Restaurant Memberships
                                </p>
                        ...
                        @endif
                        @if(request()->is('show_guest_types'))
                        <li class="nav-item">
                            <a href="{{ route('show_guest_types')}}" class="nav-link active" style="background-color: #0065A3; color: #fff;">
                                <i class="nav-icon fas fa-user" style="color: #fff;"></i>
                                <p style="color: #fff;">
                                    Restaurant Guest Types
                                </p>
                            </a>
                        </li>
                        @else
                        <li class="nav-item">
                            <a href="{{ route('show_guest_types')}}" class="nav-link">
                                <i class="nav-icon fas fa-user" style="color: #fff;"></i>
                                <p style="color: #fff;">
                                    Restaurant Guest Types
                                </p>
                        ...
                        @endif
                        @if(request()->is('Restaurant_users'))
                        <li class="nav-item">
                            <a href="{{ route('Restaurant_users')}}" class="nav-link active" style="background-color: #0065A3; color: #fff;">
                        ...
                        @else
                        <li class="nav-item">
                            <a href="{{ route('Restaurant_users')}}" class="nav-link">
                                <i class="nav-icon fas fa-users" style="color: #fff;"></i>
                                <p style="color: #fff;">
                                    Restaurant Users
                                </p>
